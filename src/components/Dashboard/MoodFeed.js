...
const CustomizedDot = props => {
  ...
  return (
    <svg x={cx - 10} y={cy - 10} width={20} height={20} fill="#E7677C" viewBox="0 0 1024 1024">
    ...
    getRequest('getAverageMoodsWeekly')
      .then(response => {
        ...
        Object.keys(resp).forEach(function(key) {
          if (key < 5) arr.push({ name: Days[key], mood: resp[key] });
        });
      ...
      <CustomPanel title={'General Mood Last Week'}>
        <div id="mood-panel">
          ...
          >
            ...
            <Line type="monotone" dataKey="mood" stroke="#193852" yAxisId={0} dot={<CustomizedDot />} />
          </LineChart>
        </div>
      </CustomPanel>
    );
