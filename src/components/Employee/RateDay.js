          ...
          {!this.state.rated ?
            <div className="rate-day-emoticons">
              <div className="emotion-container">
                <i onClick={this.onRate} className="material-icons green">mood</i>
                <div className="green">Happy</div>
              </div>
              <div className="emotion-container">
                <i onClick={this.onRate} className="material-icons green">sentiment_satisfied</i>
                <div className="green">Nice</div>
              </div>
              <div className="emotion-container">
                <i onClick={this.onRate} className="material-icons yellow">sentiment_neutral</i>
                <div>Neutral</div>
              </div>
              <div className="emotion-container">
                <i onClick={this.onRate} className="material-icons red">sentiment_dissatisfied</i>
                <div className="red">Saddish</div>
              </div>
              <div className="emotion-container">
                <i onClick={this.onRate} className="material-icons red">mood_bad</i>
